...
const SideNavigation: FC = () => {
    ...
    return <motion.div
        layout
        className={"sticky row-span-2 top-0 bottom-0 left-0 transition bg-background-200/50 backdrop-blur dark:bg-background-800 rounded-r-2xl border-2 border-background-200 dark:border-background-700 shadow-2xl px-2 lg:px-5 py-16 lg:w-full max-w-sm"}
    >
